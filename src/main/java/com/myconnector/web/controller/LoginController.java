...
public class LoginController extends SimpleFormController {
    ...
    private void setCounts(HttpServletRequest req) {
        int bookmarkCount = bookmarkService.getList().size();
        req.setAttribute("bookmarkCount", String.valueOf(bookmarkCount));
        int cacheCount = bookmarkService.getPageCacheCount();
        req.setAttribute("pageCacheCount", String.valueOf(cacheCount));
        int pageListCount = bookmarkService.getPageListCount();
        req.setAttribute("pageListCount", String.valueOf(pageListCount));
        // TODO count actual pages indexed
    }
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response,
        ...
        if (userData != null) {
            ...
            if (login.getRemember() != null && login.getRemember().booleanValue()) {
                ...
                String cookieValue = cookie.getId() + ":" + userData.getId();
